...
public class Flow1 {
	...
	public void new_LeadNoticer() throws Exception
	{
		...
		Thread.sleep(6000);
		    ...
		    offerfamily.selectByVisibleText("Denmark Offering1");
		    driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		    
		    //Select offering name
		    Select offername = new Select(driver.findElement(By.id("Offeringname")));
		    offername.selectByVisibleText("Denmak offering");
		    driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
   ...
   //-----------------------Additional Details---------------------------------------------------
	...
	public void login_FpRole() throws Exception
	{
	    ...
	    //Choose CF
	    Select cf = new Select(driver.findElement(By.id("CustomerFulfilmentPrep")));
	    cf.selectByVisibleText("Bharathi-bhakondu@in.ibm.com");
	    driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
