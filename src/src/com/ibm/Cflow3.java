...
public class Cflow3 {
	...
	public void homePage() throws Exception{
		...
		driver.get("https://w3beta-2.toronto.ca.ibm.com/tools/wse_mf/runtime/hspx/dev/protect/X0038/xDNSO/page/home?x_role=Noticer");
	...
	public void new_LeadNoticer() throws Exception
	{
		...
		//Thread.sleep(2000);
	 //driver.findElement(By.linkText("Noticer home page")).sendKeys(Keys.ARROW_RIGHT);
	// driver.findElement(By.partialLinkText("New lead")).click();
		 //Thread.sleep(6000);
		...
		//clicking new lead tab
		    ...
		    //Lead description
		    driver.findElement(By.xpath(".//*[@id='LeadDescription']")).sendKeys("new lead");
			Screenshot.CapturexDNSOScreenshot(driver, "Lead details added successfully");
	
	//-----------------------------------Maintenance details----------------------------------------------------
		    
		    //machine type
		     driver.findElement(By.xpath(".//*[@id='machinetype']")).sendKeys("New");
		     //driver.findElement(By.name("machinetype")).sendKeys("new123");
		     //driver.findElement(By.xpath(".//*[contains(@name,'machinetype')]")).sendKeys("New123");
		    //model
	...
	//--------------------------------Customer Data----------------------------------------------------- 
		     ...
		     //customer code
			 driver.findElement(By.xpath(".//*[@id='CustomerCode']")).sendKeys("626396");
   ...
   //-----------------------Additional Details---------------------------------------------------
	...
	public void login_FpRole() throws Exception
	{
		...
		//clicking on Lead id
	    driver.findElement(By.xpath(".//*[@id='searchLeadTable']/tbody/tr/td[2]/a")).click();
		Thread.sleep(8000);
	    ...
	    //Choose CF
	    Select cfRole = new Select(driver.findElement(By.id("ChooseCF")));
	    cfRole.selectByVisibleText("Bharathi-bhakondu@in.ibm.com");
	    driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	    ...
	    //alert accept
	 	...
	 	public void login_CfRole() throws Exception{
	 	  ...
	 	  //Click on Additional details tab
	 		driver.findElement(By.partialLinkText("Additonal details")).click();
	 		Thread.sleep(6000); 
